...
check_flag SETUP.md setup-linux.sh "--company"
check_flag SETUP.md setup-linux.sh "--help"
check_flag SETUP.md setup-mac.sh   "--wezterm"
check_flag SETUP.md setup-mac.sh   "--docker"
check_flag SETUP.md setup-mac.sh   "--force"
check_flag SETUP.md setup-mac.sh   "--company"
check_flag SETUP.md setup-mac.sh   "--help"
...
check_flag SETUP.md setup-windows.ps1 "-Company"
check_flag SETUP.md setup-windows.ps1 "-Help"
...
check_flag SETUP_ko.md setup-linux.sh "--company"
check_flag SETUP_ko.md setup-linux.sh "--help"
...
check_flag SETUP_ko.md setup-mac.sh   "--company"
check_flag SETUP_ko.md setup-mac.sh   "--help"
...
check_flag SETUP_ko.md setup-windows.ps1 "-Company"
check_flag SETUP_ko.md setup-windows.ps1 "-Help"
